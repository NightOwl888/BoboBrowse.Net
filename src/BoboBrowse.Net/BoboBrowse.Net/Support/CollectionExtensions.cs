...
namespace BoboBrowse.Net.Support
{
    ...
    {
        public static T Get<T>(this ICollection<T> enumerable, int index) where T : class
        {
        ...
        public static T Get<T>(this ICollection<T> enumerable, int index, T defaultValue)
        {
            if (index < enumerable.Count)
                return enumerable.ElementAt(index);
            else
        ...
        /// <summary>
        /// Converts an ICollection to a display string by calling the ToString() method of the inner type.
        ...
        public static string ToDisplayString<T>(this ICollection<T> enumerable)
        {
            if (enumerable == null)
            {
                return string.Empty;
