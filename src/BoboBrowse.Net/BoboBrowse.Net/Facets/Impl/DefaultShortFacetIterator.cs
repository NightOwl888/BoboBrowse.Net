...
namespace BoboBrowse.Net.Facets.Impl
{
    ...
    /// <para/>
    /// NOTE: This was DefaultShortFacetIterator in bobo-browse
    /// </summary>
    public class DefaultInt16FacetIterator : Int16FacetIterator
    {
        private readonly TermInt16List m_valList;
        private BigSegmentedArray _count;
        private int m_countlength;
        private int m_countLengthMinusOne;
        private int m_index;

        public DefaultInt16FacetIterator(TermInt16List valList, BigSegmentedArray countarray, int countlength, bool zeroBased)
        {
            m_valList = valList;
        ...
        /// </summary>
        public virtual TermInt16List ValList
        {
        ...
        new public virtual string Facet
        {
            get
            {
                if (m_facet == TermInt16List.VALUE_MISSING) return null;
