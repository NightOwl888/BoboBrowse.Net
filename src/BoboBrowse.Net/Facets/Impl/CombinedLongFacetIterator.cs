...
namespace BoboBrowse.Net.Facets.Impl
{
    ...
    public class CombinedLongFacetIterator : LongFacetIterator
    {
        ...
        public class LongFacetPriorityQueue
        {
            ...
            public sealed void Put(LongIteratorNode element)
            {
                size++;
                heap[size] = element;
                UpHeap();
            ...
            public sealed LongIteratorNode Add(LongIteratorNode element)
            {
                size++;
                heap[size] = element;
                UpHeap();
            ...
            public bool Insert(LongIteratorNode element)
            {
            ...
            public sealed LongIteratorNode Top()
            {
             ...
             * time.
             */
            public sealed LongIteratorNode Pop()
            {
                if (size > 0)
                {
            ...
            public sealed LongIteratorNode UpdateTop()
            {
                DownHeap();
                return heap[1];
            }
